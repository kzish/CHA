...
namespace Admin.Controllers
{
    ...
    public class CourseController : Controller
    {
        ...
        public CourseController(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        [HttpGet("ajaxAllCourses")]
        public IActionResult ajaxAllCourses()
        {
