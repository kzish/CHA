...
text,");
            ...
            modelBuilder.Entity<MBoardGame>(entity =>
            {
                ...
                entity.HasComment("model for the board game");
            ...
            modelBuilder.Entity<MBoardGameItems>(entity =>
            {
                ...
                entity.HasComment("these are the tiles of the board gamer");
                ...
                entity.Property(e => e.ItemText)
                    ...
                    .HasMaxLength(450)
                    .IsUnicode(false)
                    .HasComment("the text of the tile");
                ...
                entity.Property(e => e.MBoardGameIdFk)
                    ...
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasComment("link to the board game");
            ...
            modelBuilder.Entity<MBoardGameTitles>(entity =>
            {
                ...
                entity.HasComment("the titles of the board games");
                ...
                entity.Property(e => e.MBoardGameIdFk)
                    ...
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasComment("links to the board game");
...
during the coursework");
            ...
            modelBuilder.Entity<MCourseExamReports>(entity =>
            {
                ...
                entity.HasComment("parent table store statistics of the exam for reporting purposes");
...
images, audio, video will be rendered and will have extra parameters to help render");
            ...
            modelBuilder.Entity<MCourseWorkProgress>(entity =>
            {
                ...
                entity.HasComment(@"monitors the progress of the coursework by the user
records the pages completed
user simply clicks a button to confirm that he/she  has gone thru this page and is recorded as progress");
                ...
                entity.Property(e => e.AspNetUserIdFk)
                    ...
                    .HasColumnName("asp_net_user_id_fk")
                    .HasMaxLength(450)
                    .HasComment("links to the user/course taker");
